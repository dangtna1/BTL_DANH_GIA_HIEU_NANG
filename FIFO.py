...
def SJF( job ): #sort jobs according to their duration purpose
    return job.duration
...
if LOGGED:
    qlog = open( 'FF_mm1-l%d-m%d.csv' % (LAMBDA,MU), 'w' )
    qlog.write( '0\t0\t0\n' )
...
if LOGGED and PLOTTED:
    ...
    log = np.loadtxt( 'FF_mm1-l%d-m%d.csv' % (LAMBDA,MU), delimiter = '\t' )
    plt.subplot( 2, 1, 1 )
    plt.xlabel( 'Time' )
